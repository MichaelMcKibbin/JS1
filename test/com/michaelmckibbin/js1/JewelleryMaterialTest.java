...
class JewelleryMaterialTest {
    ...
    @BeforeEach
    void setUp() {
        jewelleryMaterial = new JewelleryMaterial("999", "Gold", "Gold Bar", "oz", "/images/goldBars.jpg", 10, "24", 7999.00);
    }
    ...
    void testGetJewelleryMaterialPrice() {
        assertEquals(7999.00, jewelleryMaterial.getJewelleryMaterialPrice());
    }
    ...
    void testSetJewelleryMaterialPrice() {
        jewelleryMaterial.setJewelleryMaterialPrice(9999.00);
        assertEquals(9999.00, jewelleryMaterial.getJewelleryMaterialPrice());
    }
